package com.example.fuelapp.scheduleservice.config;
...
public class KafkaConsumerConfig {
    ...
    public Map<String, Object> consumerConfig(){
        ...
        props.put(JsonDeserializer.TRUSTED_PACKAGES, "com.example.fuelapp.scheduleservice.model");
        return props;
    }
    ...
    @Bean
    public KafkaListenerContainerFactory<ConcurrentMessageListenerContainer<String, Order>> fuelAllocatedListenerFactory (){
